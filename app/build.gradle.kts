...
android {
    namespace = "com.example.secgamecallenge_wordsearch"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.secgamecallenge_wordsearch"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
    ...
    composeOptions {
        kotlinCompilerExtensionVersion = "1.5.1"  // Correct version for latest Compose features
    }
    packaging {
        resources {
